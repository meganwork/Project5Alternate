...
BUT all test cases are fully implemented, classes pass all test cases!
...
relation to a lake monster or sea monster. The function does not require an overridden method for the children.

Unlike the other option the user has, scare time (line 80).
...
This can be seen again in Darkness_Monster_Main on line 34 where the scare method is called again for both the closet monsters and the monsters under the bed.
...
In the Sky_Monsters_Main function, I demonstrated polymorphism again with the calls to scare on line (34)
